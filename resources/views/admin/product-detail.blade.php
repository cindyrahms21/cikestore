			...
			<div class="row">
				...
				<div class="col-md-6 col-lg-5 p-b-30">
					<div class="p-r-50 p-t-5 p-lr-0-lg">
						<form>
						{{csrf_field()}}
						<button class="btn btn-success" formaction="{{url('admin/product-edit/'.$product->id)}}">EDIT</button></a>
						<button onclick="return confirm('Apakah anda yakin?')" class="btn btn-danger" formaction="{{url('product-delete/'.$product->id)}}">DELETE</button>
						</form>
